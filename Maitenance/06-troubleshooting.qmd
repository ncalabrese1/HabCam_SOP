...
graph TD
    ...
    Pwr["<b>Power on HabCam<br/>with 240v AC</b>"]
    FO_Check["<b>Are fiber optics and<br/>data networks online?</b>"]
    Eng_GUI["<b>Start Engineering GUI</b>"]
    Img_GUI["<b>Start Image<br/>Viewer GUI</b>"]
    Data_Verify["<b>Verify images and<br/>vehicle data are being<br/>written</b>"]
    Sonar_Start["<b>Start BlueView and<br/>Side Scan Sonars</b>"]
    ...
    %% Troubleshooting Navigation (Right Column - Blue Reference Boxes)
    ...
    %% Explicit Edge Color Formatting (Green for Yes/Pass, Red for No/Issues)
