...
<!-- PLACEHOLDER: Image showing Kontakt spray cleaner bottle and liquid soap / hot water cleaning options -->
![SubConn Approved Cleaning Products](../images/subconn-cleaning-products.png){.lightbox}
*Figure 1: Approved general contact cleaner spray (Isopropyl alcohol) and liquid soap with hot water.*
...
<!-- PLACEHOLDER: Diagram showing correct 10x OD static bend radius vs incorrect sharp cable bend -->
![Inline Cable Bending Radius Guidelines](../images/subconn-bending-radius.png){.lightbox}
*Figure 2: Minimum static cable bend radius must be 10x cable diameter (top); avoid sharp bends at cable entry (bottom).*
...
<!-- PLACEHOLDER: End-face photograph of SubConn coax connector socket array -->
![SubConn Coax Connector Face Detail](../images/subconn-coax-face.png){.lightbox}
*Figure 3: SubConn coax connector pin and rubber face configuration.*
