...
```{mermaid}
graph TD
    subgraph Submerged ["<div align='left'>Submerged Connections</div>"]
        Cam1_Sub["Cam1"]
        Cam2_Sub["Cam2"]
    ...
    subgraph TopSide ["<div align='left'>Top-side Connections</div>"]
    ...
    %% Diagram Styling
    style Submerged fill:rgba(74,144,226,0.06),stroke:#4a90e2,stroke-width:1.5px,stroke-dasharray: 4 4
    style TopSide fill:rgba(245,166,35,0.06),stroke:#f5a623,stroke-width:1.5px,stroke-dasharray: 4 4
