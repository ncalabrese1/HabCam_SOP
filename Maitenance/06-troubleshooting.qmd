...
```{mermaid}
graph TD
    %% Top Row Alignment (Process Start Left, Title Block Right)
    Pwr["Power on HabCam<br/>with 240v AC"] ~~~ Title["HabCam Troubleshooting Diagram:<br/><br/>General Vehicle Set Up"]
    ...
    %% Troubleshooting Navigation (Right Column - Blue Flags)
    ...
    Sonar_Start -->|Caution:<br/>Do not leave sonars running<br/>out of water, transducers may<br/>burn out| Sonar_Action
    ...
    classDef title fill:#dbeafe,stroke:#3b82f6,stroke-width:1.5px,color:#000000;
    ...
    %% Explicit Edge Color Formatting
    linkStyle 1,2,5,8,11,14 stroke:#ff0000,stroke-width:2px,color:#ff0000;
    linkStyle 3,6,9,12 stroke:#00c853,stroke-width:2px,color:#00c853;
    linkStyle 0,4,7,10,13 stroke:#000000,stroke-width:1.5px,color:#000000;
```
